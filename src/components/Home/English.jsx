...
export default function English() {
  return (
    <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full' >
        ...
        <p className='text-[#8892b0] py-4 max-w-[700px] '> I'm a full-stack developer specializin in building (and ocassionaly
          designing) exceptcional digital experiences. Currently, I'm focused on
